...
public class physik extends AppCompatActivity implements OnClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new ItemListModel(0,getString(R.string.angel),getResources().getDrawable(R.drawable.angel_icon)));
        arrayList.add(new ItemListModel(1,getString(R.string.power),getResources().getDrawable(R.drawable.power_icon)));
        arrayList.add(new ItemListModel(2,getString(R.string.temperature),getResources().getDrawable(R.drawable.temperature_icon)));
        arrayList.add(new ItemListModel(3,getString(R.string.acceleration),getResources().getDrawable(R.drawable.acceleration_icon)));
        arrayList.add(new ItemListModel(4,getString(R.string.speed),getResources().getDrawable(R.drawable.speed_icon)));
        arrayList.add(new ItemListModel(5,getString(R.string.pressure),getResources().getDrawable(R.drawable.pressure_icon)));
        arrayList.add(new ItemListModel(6,getString(R.string.weight),getResources().getDrawable(R.drawable.weight_icon)));
