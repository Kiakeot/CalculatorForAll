...
public class life extends AppCompatActivity implements OnClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new ItemListModel(0,getString(R.string.data),getResources().getDrawable(R.drawable.data_icon)));
        arrayList.add(new ItemListModel(1,getString(R.string.BMI),getResources().getDrawable(R.drawable.bmi_icon)));
        arrayList.add(new ItemListModel(2,getString(R.string.fuel),getResources().getDrawable(R.drawable.fuel_icon)));
        arrayList.add(new ItemListModel(3,getString(R.string.dataStorage),getResources().getDrawable(R.drawable.data_storage_icon)));
        arrayList.add(new ItemListModel(4,getString(R.string.dataRate),getResources().getDrawable(R.drawable.data_rate_icon)));
